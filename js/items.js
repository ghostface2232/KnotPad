...
function setupItemEvents(item) {
    ...
    if (item.type === 'memo') {
        ...
        function showToolbarNearSelection() {
            ...
            let top = rect.top - toolbarHeight - 36;
